...
class Result(models.Model):
    ...
    _1st_term_card = models.CharField(max_length=255, default=None)
    _2nd_term = models.FileField(upload_to='results/2nd_term/', default=None)
    _2nd_term_card = models.CharField(max_length=255, default=None)
    _3rd_term = models.FileField(upload_to='results/3rd_term/', default=None)
    _3rd_term_card = models.CharField(max_length=255, default=None)
